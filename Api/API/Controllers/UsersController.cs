...
namespace API.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        /// <returns>
        /// Returns 200 OK when the avatar is successfully deleted; otherwise an error response produced by <see cref="BaseController.HandleError(Result, string, ILogger, Guid?)"/>.
        /// </returns>
        /// <remarks>
        ...
        /// <returns>
        /// Returns 200 OK when the avatar is successfully replaced; otherwise an error response produced by
        /// <see cref="BaseController.HandleError(Result, string, ILogger, Guid?)"/>.
        /// </returns>
        /// <remarks>
        ...
        /// otherwise an error response produced by <see cref="BaseController.HandleError(Result, string, ILogger, Guid?)"/>.
        /// </returns>
        /// <remarks>
        ...
        /// </param>
        /// <returns>
        /// Returns 200 OK with a list of <see cref="GetUsersResponse"/> items when successful; otherwise an error response generated by <see cref="BaseController.HandleError(Result, string, ILogger, Guid?)"/>.
        /// </returns>
        /// <remarks>
        /// Route: GET api/users
        /// Authorization: Required.
        /// Query parameters:
        ///   - search: string
        ///   - invitableFor: Guid (required)
        ///
        /// Note: Currently, only retrieval using the invitableFor filter is supported by the application, as it is the only required scenario.
        ...
        /// </param>
        /// <returns>
        /// Returns 200 OK with a list of <see cref="GetChatsResponse"/> when successful; otherwise an error response
        /// produced by <see cref="BaseController.HandleError(Result, string, ILogger, Guid?)"/>
        /// </returns>
        /// <remarks>
